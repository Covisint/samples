...
import com.covisint.platform.service.client.service.request.ServicePackageRequestClient;
import com.covisint.platform.service.client.service.request.ServicePackageRequestSDK;
...
public class ServicePackageRequestSDKSamples {
    ...
    private static ServicePackageRequestClient createServicePackageRequestClient() {
        return new ServicePackageRequestSDK(ServiceUrl.SERVICE_V1.getValue()).create();
    }
    ...
    public static void servicePackageRequestCRUD() {
        ...
        ServicePackageRequest createdRequest = client.add(request, new BasicHttpContext()).checkedGet();
        ...
        ServicePackageRequest retrievedRequest = client.get(createdRequest.getId(), new BasicHttpContext())
                .checkedGet();
        ...
        // Execute the search.
        List<ServicePackageRequest> results = client.search(filter, SortCriteria.NONE, Page.DEFAULT,
        ...
        client.delete(retrievedRequest.getId(), new BasicHttpContext()).checkedGet();
    }
