...
@property (strong, nonatomic) IBOutlet UITableView *credentialsTableView;
...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.credentialsTableView.estimatedRowHeight = 100.0;
    self.credentialsTableView.rowHeight = UITableViewAutomaticDimension;
